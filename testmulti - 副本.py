...
if __name__ == "__main__":
    ...
    for i in size:
        ...
        P_naive_res, t_naive_res = cuda_model.multi_naive(M, N, M_w, M_h, N_w)
        P_shared, t_shared = cuda_model.multi_tile(M, N, M_w, M_h, N_w)
        P_shared_res, t_shared_res = cuda_model.multi_tile(M, N, M_w, M_h, N_w)
    ...
    plt.plot(size, t_res_list, label="naive+res ")
